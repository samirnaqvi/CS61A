...
def if_this_not_that(i_list, this):
    ...
    5
    """
    [print('that') if x <=this else print(x) for x in i_list]
    "*** YOUR CODE HERE ***"
...
def put_piece(board, max_rows, column, player):
    ...
    #print(index)
    if( index>=0):
        board= replace_elem(board, n, replace_elem(board[index], column, player))
    return (index,board)
